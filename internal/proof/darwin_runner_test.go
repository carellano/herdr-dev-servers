...
func TestDurableDarwinRunner(t *testing.T) {
	for _, tt := range []struct {
		...
		{"metadata mismatch", func(f *fakeDarwin) { f.metadata[1].Values["dev_servers"] = "wrong" }, ErrEvidence},
