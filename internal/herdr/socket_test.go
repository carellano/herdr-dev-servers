...
func TestProtocolRequestShapes(t *testing.T) {
	for _, tt := range []struct {
		...
		{request{ID: "3", Method: "workspace.report_metadata", Params: MetadataRequest{WorkspaceID: "w", Source: "herdr-dev-servers", Tokens: map[string]*string{"dev_servers": nil}}}, `{"id":"3","method":"workspace.report_metadata","params":{"workspace_id":"w","source":"herdr-dev-servers","tokens":{"dev_servers":null}}}`},
	} {
